...
class EditContact extends Component {
    ...
    render() {
        let { Name, Phone, Email, Gender, Status, Image } = this.props.CurrentContact;
                        ...
                        <div className="col-8">
                            <form onSubmit={this.UpdateContact}>
                                <div className="form-group">
                                    ...
                                    <input name="Name" type="text" className="form-control" defaultValue={Name} onChange={this.getName} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="Phone">Phone</label>
                                    <input name="Phone" type="tel" className="form-control" defaultValue={Phone} onChange={this.getPhone} />
                                </div>
                                <div className="form-group">
                                    <label htmlFor="email">Email address</label>
                                    <input type="email" className="form-control" defaultValue={Email} onChange={this.getEmail} />
                                </div>
                                <div className="form-group">
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="number" min="0" max="99" defaultValue={Image} className="form-control" onChange={this.getAvatar} />
                                </div>
